...
public partial class GameEntity {
    ...
    public void AddPlayECSIngredientContainerView(Play.ECS.IngredientsContainerViewBehaviourBehaviour newView, System.Collections.Generic.Stack<Core.Game.Play.ECS.IngredientTypes> newIngredients) {
    ...
    public void ReplacePlayECSIngredientContainerView(Play.ECS.IngredientsContainerViewBehaviourBehaviour newView, System.Collections.Generic.Stack<Core.Game.Play.ECS.IngredientTypes> newIngredients) {
        var index = GameComponentsLookup.PlayECSIngredientContainerView;
        var component = (Play.ECS.IngredientContainerViewComponent)CreateComponent(index, typeof(Play.ECS.IngredientContainerViewComponent));
        component.View = newView;
        component.Ingredients = newIngredients;
